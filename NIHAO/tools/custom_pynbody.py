...
def map_nihao(*args):
    ...
    for data in args:
        ...
        pynbody.plot.stars.render(h[1].s, width="10 kpc", axes=axs[0, 0])
        pynbody.plot.image(
            h[1].g, qty="rho", units="g cm^-3", width="10 kpc", cmap="Greys", subplot=axs[0, 1], threaded=False
        )  # 1,0
        # axs[0, 0].pynbody.plot.image(h[1].g, qty="temp", width="10 kpc") #1,1
        sph.image(
            h[1].g,
            qty="temp",
            width=50,
        ...
        pynbody.plot.stars.render(h[1].s, width="10 kpc", axes=axs[1, 0])
        pynbody.plot.image(
            h[1].g, qty="rho", units="g cm^-3", width="10 kpc", cmap="Greys", subplot=axs[1, 1], threaded=False
        )  # 2,0
        # pynbody.plot.image(h[1].g, qty="temp", width="10 kpc") #2,1
        sph.image(
            h[1].g,
            qty="temp",
            width=50,
